    ...
    return (
        <div className="step-content">
            <div className='flex flex-col items-center gap-4 py-4 sm:py-8'>
                ...
                <input
                    type="text"
                    className='bg-white border-gray-400 border-[1px] sm:py-2 sm:px-4 px-3 py-2 w-[80%] sm:w-[70%] max-w-[400px] text-md sm:text-md manrope-regular text-black rounded-md focus:outline-hidden focus:ring-2 focus:ring-primary focus:ring-opacity-50'
