...
export const exampleBooks = [
    {
        ...
        notes: [
            ...
            "Google has a science led approach and Apple has a design led approach. Apple is therefore more visible and Google is faceless.",
    ...
    },
    {
        ...
        notes: [
            ...
            "The further we move away from jobs measured by task and time towards work that is personal and subjective, the closer we move to invisible work. Each component becomes harder to see. 1. Working from Home: from buildings to brains. 2. The Power of the Imagination: from public to private. 3. The Capacity to Learn: from education to learning. 4. The Ideas Business: from innovation to creativity. 5. The Search for Self-fulfilment: from anonymity to meaning. 6. Taking Charge: from hierarchies to self-management. 7. Plural Work: from one job to building a personal portfolio. 8. The Four Circles: a model of invisible work.",
